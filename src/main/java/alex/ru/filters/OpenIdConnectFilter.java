...
import alex.ru.conf.sub.auth.OpenIdConnectUserDetails;
...
public class OpenIdConnectFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public OpenIdConnectFilter(final String defaultFilterProcessesUrl) {
    ...
    private RsaVerifier verifier(final String kid) throws Exception {
    ...
    @Autowired
    public void setRestTemplate(final OAuth2RestTemplate restTemplate2) {
